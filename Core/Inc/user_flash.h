...
#define BOOTMEMORYINFO			(*((uint32_t *)0x0803F800))  /* Store info related to FW Boot point for FW Jump */
#define BOOTMEMORYADDRESS		ADDR_FLASH_PAGE_127 //((uint32_t)0x0801F800)

/* Notable Flash addresses */
//#define FLASH_START		        ADDR_FLASH_PAGE_0           /*Start addr of Flash Memory*/
#define USER_FLASH_END_ADDRESS  ADDR_FLASH_PAGE_127 			/*End addr of Flash Memory as STM32L433 is of 128KB, 2kb each*/

#define FLASH_X_START_ADDR   	(ADDR_FLASH_PAGE_1 )		   	/* Start @ of X Flash area */
#define FLASH_X_END_ADDR     	(ADDR_FLASH_PAGE_63) 	    /* End @ of X Flash area */

//#define FLASH_START_ADDR      	((uint32_t)0x0803F800)

#define FLASH_Y_START_ADDR	 	(ADDR_FLASH_PAGE_64) 	   /* Start @ of Y Flash area */
#define FLASH_Y_END_ADDR      	(ADDR_FLASH_PAGE_126)	   /* End @ of Y Flash area */

#define BOOT_MEM_X				((uint32_t)0x7E)
#define BOOT_MEM_X_JUMP			((uint64_t)0x58)
#define BOOT_MEM_Y				((uint32_t)0x7F)
#define BOOT_MEM_Y_JUMP			((uint64_t)0x59)
